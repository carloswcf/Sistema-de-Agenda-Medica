...
<div class="base-listas">
				<span class="titulo1"><a name="consulta"></a>Lista de cliente</span>
			...
			<div class="d-flex justify-content-space-between base-busca">
				<a href="{{route('paciente.create')}}" class="but butcad">Cadastrar cliente</a>
		...
		<div class="rows">
				...
				<table id="dataTable" width="100%" cellpadding="0" cellspacing="0" class="tabela">		
					...
					<tbody>				 
						...
						<td align="center"><a href="{{route('paciente.edit', $paciente->id)}}" class="editar but">Editar</a></td>
						<td align="center"><a href="javascript: if(confirm('Deseja realmente excluir ?')){
                                                                      window.location.href = '{{route('paciente.excluir', $paciente->id)}}' }
